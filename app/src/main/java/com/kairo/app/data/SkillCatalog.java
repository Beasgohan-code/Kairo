...
public final class SkillCatalog {
    private static final List<SkillDefinition> SKILLS = Collections.unmodifiableList(Arrays.asList(
            ...
            new SkillDefinition("multi-language", "Polyglot coding", "Respect JS, TS, Kotlin, Java, C++, C, Assembly, CSS, and shell presets.",
                    "Honor the selected language preset (JavaScript, TypeScript, Kotlin, Java, C++, C, Assembly, CSS, shell, Python, HTML, JSON). Keep syntax, package conventions, filenames, and run instructions appropriate to that language; for C/C++/Assembly emphasize correctness and realistic build steps; do not translate a request into another language without saying so.", true),
            new SkillDefinition("perf-native", "Native performance", "When writing C, C++, or Assembly, optimize for clarity first then measured hot paths.",
                    "For performance-sensitive native code: prefer clear algorithms, note complexity, avoid undefined behavior, document architecture assumptions for assembly, and separate portable C from platform-specific paths. Never claim device-side native execution succeeded unless the environment actually ran it.", false),
