...
public final class ModelCatalog {
    ...
    private static final List<ModelInfo> CURATED = Collections.unmodifiableList(Arrays.asList(
            // Experiential Labs — OpenAI-compatible gateway (api.experientiallabs.ai/v1).
            model("gpt-6-astra", "GPT-6 Astra", "experiential",
                    "Frontier long-context model via Experiential Cloud · 1.05M context", false, false, "1.05M",
                    "Experiential Cloud · provider list price / credits apply"),
            model("gpt-6-astra-pro", "GPT-6 Astra Pro", "experiential",
                    "Higher-capability Astra route when your account exposes it", false, false, "1.05M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("claude-fable-5.1", "Claude Fable 5.1", "experiential",
                    "Recommended deep-reasoning Claude route on Experiential", false, false, "1M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("claude-fable-5", "Claude Fable 5", "experiential",
                    "Fast Claude Fable route with strong coding quality", false, false, "1M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("claude-opus-5", "Claude Opus 5", "experiential",
                    "High-capability Claude Opus route", false, false, "1M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("claude-sonnet-5", "Claude Sonnet 5", "experiential",
                    "Balanced Claude Sonnet route — strong speed/quality tradeoff", false, false, "1M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("gpt-5.6-sol", "GPT-5.6 Sol", "experiential",
                    "Prior-gen flagship GPT route still useful for everyday work", false, false, "1.05M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("gpt-5.6-luna", "GPT-5.6 Luna", "experiential",
                    "Fast GPT route; often listed on Experiential promotional rows", true, false, "1.05M",
                    "Promo / free tier when advertised · otherwise provider billing"),
            model("gemini-3.7-flash", "Gemini 3.7 Flash", "experiential",
                    "Very fast multimodal Gemini Flash route", false, false, "1.05M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("kimi-k3", "Kimi K3", "experiential",
                    "Long-context Kimi reasoning route through Experiential", false, false, "1.05M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("glm-5.3", "GLM 5.3", "experiential",
                    "Strong general GLM route", false, false, "1.05M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("glm-5.3-flash", "GLM-5.3 Flash", "experiential",
                    "Ultra-fast GLM flash route for snappy chat", false, false, "1.31M",
                    "Experiential Cloud · provider billing / credits apply"),
            model("deepseek-v4-flash", "DeepSeek V4 Flash", "experiential",
                    "Fast DeepSeek route; often free on Experiential promo rows", true, false, "1.05M",
                    "Promo / free tier when advertised · otherwise provider billing"),
            model("qwen3.8-27b", "Qwen3.8 27B", "experiential",
                    "Open Qwen route; often free on Experiential promo rows", true, false, "1M",
                    "Promo / free tier when advertised · otherwise provider billing"),
            ...
            model("openai/gpt-6-astra", "GPT-6 Astra (OpenRouter)", "openrouter",
                    "GPT-6 Astra routed through OpenRouter when available", false, false, "1.05M",
