...
public final class ToolRegistry {
    private static final List<ToolSpec> TOOLS = Collections.unmodifiableList(Arrays.asList(
            ...
            new ToolSpec("safe_cli", "Safe CLI diagnostics",
                    "Run only commands accepted by CliCommandPolicy in the Ubuntu-style sandbox terminal.", false, false),
            new ToolSpec("voice_assistant", "Voice assistant",
                    "Capture speech, route assistant commands, or dictate into the streaming composer.", false, false),
            new ToolSpec("camera_capture", "Camera capture",
                    "Open the system camera and attach a reviewed photo thumbnail to the next chat turn.", true, false),
            new ToolSpec("file_templates", "File templates",
                    "Create polyglot starter files (JS/TS/Java/Kotlin/C/C++/py/css/xml/md/txt/zip…) in private storage.", true, false),
